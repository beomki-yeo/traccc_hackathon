...
__global__ void matmul_kernel(vecmem::data::vector_view<matrix_t> A_view,
                              vecmem::data::vector_view<matrix_t> B_view,
                              vecmem::data::vector_view<matrix_t> C_view);

// explicit instantiation of matmul function
template void matmul<Acts::BoundSymMatrix>(
    int n_matrix, vecmem::data::vector_view<Acts::BoundSymMatrix> A_view,
    vecmem::data::vector_view<Acts::BoundSymMatrix> B_view,
    vecmem::data::vector_view<Acts::BoundSymMatrix> C_view, float& elapsed);

// explicit instantiation of matmul function
template void matmul<Acts::FreeSymMatrix>(
    int n_matrix, vecmem::data::vector_view<Acts::FreeSymMatrix> A_view,
    vecmem::data::vector_view<Acts::FreeSymMatrix> B_view,
    vecmem::data::vector_view<Acts::FreeSymMatrix> C_view, float& elapsed);

// Definition of matmul function
template <typename matrix_t>
void matmul(int n_matrix, vecmem::data::vector_view<matrix_t> A_view,
            vecmem::data::vector_view<matrix_t> B_view,
            vecmem::data::vector_view<matrix_t> C_view, float& time) {
