...
struct doublet_counter{
    ...
    /// Convenience declaration for the doublet_counter collection type to use in host code
    using host_doublet_counter_collection
    = doublet_counter_collection< vecmem::vector >;

    /// Convenience declaration for the doublet_counter collection type to use in device code
