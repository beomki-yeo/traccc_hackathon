...
void seed_weight(const seedfilter_config& filter_config,
...
static __CUDA_HOST_DEVICE__    
bool single_seed_cut(const seedfilter_config& filter_config,
		     const internal_spacepoint<spacepoint>& spB,
...
static __CUDA_HOST_DEVICE__    
bool cut_per_middle_sp(const seedfilter_config& filter_config,
		       const internal_spacepoint<spacepoint>& spB,
		       const scalar& triplet_weight){
