...
Acts::BoundVector transform_free_to_bound_parameters(const Acts::FreeVector& free_vector, const surface_t& surface){
    ...
    double theta = std::atan2(std::sqrt(dir[0] * dir[0] + dir[1] * dir[1]), dir[2]);
