...
/// code
using host_truth_spacepoint_container = host_container<truth_particle, spacepoint>;

/// Convenience declaration for the spacepoint container type to use in device
/// code
using device_truth_spacepoint_container = device_container<truth_particle, spacepoint>;
/// Convenience declaration for the spacepoint container data type to use in
/// host code
using truth_spacepoint_container_data = container_data<truth_particle, spacepoint>;

/// Convenience declaration for the spacepoint container buffer type to use in
/// host code
using truth_spacepoint_container_buffer = container_buffer<truth_particle, spacepoint>;

/// Convenience declaration for the spacepoint container view type to use in
/// host code
using truth_spacepoint_container_view = container_view<truth_particle, spacepoint>;
