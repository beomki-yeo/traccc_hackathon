...
namespace traccc {
  ...
  using spacepoint_writer = dfe::NamedTupleCsvWriter<csv_spacepoint>;
	...
	DFE_NAMEDTUPLE(csv_multiplet_statistics, n_spM, n_mid_bot_doublets, n_mid_top_doublets, n_triplets);
    };
    
    using multiplet_statistics_writer = dfe::NamedTupleCsvWriter<csv_multiplet_statistics>;
